...
namespace ITfoxtec.Identity.Saml2.Schemas.Metadata
{
    ...
    public class Organization
    {
        ...
        protected IEnumerable<XObject> GetXContent()
        {
            ...
            {
                element = new XElement(Saml2MetadataConstants.MetadataNamespaceX + Saml2MetadataConstants.Message.OrganizationName, OrganizationName);
            }

            if (OrganizationDisplayName != null)
            {
                element =  new XElement(Saml2MetadataConstants.MetadataNamespaceX + Saml2MetadataConstants.Message.OrganizationDisplayName, OrganizationDisplayName);
            }

            if (OrganizationURL != null)
            {
                element =  new XElement(Saml2MetadataConstants.MetadataNamespaceX + Saml2MetadataConstants.Message.OrganizationURL, OrganizationURL);
            }
            
            element.SetAttributeValue(Saml2MetadataConstants.AttributeLanguageFormat,"en-GB");
