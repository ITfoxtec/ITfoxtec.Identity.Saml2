...
//        public Saml2SignedXml(XmlElement element, RSA rsa, string signatureAlgorithm) : base(element)
//        {
...
//            reference.AddTransform(new XmlDsigEnvelopedSignatureTransform());
//            reference.AddTransform(new XmlDsigExcC14NTransform());
//            reference.DigestMethod = Cryptography.SignatureAlgorithm.DigestMethod(SignatureAlgorithm);
//            AddReference(reference);
...
//            var canonicalizationMethodValid = SignedInfo.CanonicalizationMethod == XmlDsigExcC14NTransformUrl;
//            var signatureMethodValid = SignedInfo.SignatureMethod == SignatureAlgorithm;
//            if (!(canonicalizationMethodValid && signatureMethodValid))
//            {
//                return false;
//            }
//            else
//            {
//                return CheckSignature(rsa, true);
//            }
//        }
//    }
//}
