        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.BindConfig<Saml2Configuration>(Configuration, "Saml2", (serviceProvider, saml2Configuration) =>
            {
                ...
                if (entityDescriptor.IdPSsoDescriptor != null)
                {
                    ...
                    saml2Configuration.ArtifactResolutionService = entityDescriptor.IdPSsoDescriptor.ArtifactResolutionServices.Select(s => new Saml2IndexedEndpoint { Index = s.Index, Location = s.Location }).First();
