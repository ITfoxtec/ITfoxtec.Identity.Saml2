...
The ITfoxtec Identity Saml2 package support signing/encryption certificates Azure Key Vault and is tested for compliance with AD FS, Azure AD and Azure AD B2C. 
